            ...
            <div class="row">
                <div class="inputform offset-1 offset-md-1 col-10 col-md-10">
                    ...
                    <div>
                        ...
                        value="<?= isset($userObj->date_of_birthday) ? htmlspecialchars($userObj->date_of_birthday) : '' ?>">
                        <p class="red">
                    ...
                    <div>
                        ...
                        value="<?= isset($userObj->zipcode) ? htmlspecialchars($userObj->zipcode) : '' ?>" autocomplete="postal-code" id="zipcode">
                        <p class="red">
                            <?= $errors['zipcode'] ?? '' ?>
                        </p>
                    </div>
