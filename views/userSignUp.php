            ...
            <div class="row">
                <div class="inputform offset-1 offset-md-1 col-10 col-md-10">
                    ...
                    <div>
                        ...
                        <input class="form-control form-control-lg " type="text" id="firstname" name="firstname" autocomplete="given-name" 
                        pattern="<?= REGEX_NAME ?>" required>
                        <p class="red">
                            <?= $errors['firstname'] ?? '' ?>
                        </p>
                    ...
                    <div>
                        <label class="form-label" for="dateOfBirthday">Date de naissance </label>
                        <input class="form-control form-control-lg " type="date" id="dateOfBirthday" name="dateOfBirthday" max="<?= $dateNow ?>">
                        <p class="red">
