            ...
            <div class="row">
                <div class="inputform offset-1 offset-md-1 col-10 col-md-10">
                    ...
                    if (isset($_SESSION['users'])) {
                        ...
                        if ($userRole == 1) { ?>
                            <h3 class="nav-item">
                                <a class="nav-link active" aria-current="page" href="/controllers/dashboard/dashboard_home-ctrl.php">Dashboard</a>
                            </h3>
                    <?php
                        }
                    }
                    ...
                    <div>
                        ...
                        <input class="form-control form-control-lg" id="passWord2" type="password" name="password2" pattern="<?= REGEX_PASSWORD ?>">
