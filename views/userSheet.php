            ...
            <div class="row">
                <div class="inputform offset-1 offset-md-1 col-10 col-md-10">
                    <div>
                        ...
                        autocomplete="family-name" pattern="<?= REGEX_NAME ?>" value="<?= isset($userObj->lastname) ? htmlspecialchars($userObj->lastname) : '' ?>">
                        <p class="red">
                            <?= $errors['lastname'] ?? '' ?>
                        </p>
                    </div>
                    <div>
                        ...
                        <input class="form-control form-control-lg" type="text" id="firstnames" name="firstname" 
                        autocomplete="given-name" pattern="<?= REGEX_NAME ?>" value="<?= isset($userObj->firstname) ? htmlspecialchars($userObj->firstname) : '' ?>">
                        <p class="red">
                            <?= $errors['firstname'] ?? '' ?>
                        </p>
                    </div>
                    <div>
                        ...
                        <input class="form-control form-control-lg" type="date" id="birthdaydate" name="dateOfBirthday" 
                        max="<?= $dateNow ?>" value="<?= isset($userObj->date_of_birthday) ? htmlspecialchars($userObj->date_of_birthday) : '' ?>">
                        <p class="red">
                    ...
                    <div>
                        ...
                        <input class="form-control form-control-lg" maxlength="5" type="text" placeholder="Entrez un code postal" 
                        name="zipcode" value="<?= isset($userObj->zipcode) ? htmlspecialchars($userObj->zipcode) : '' ?>" 
                    ...
                    <div>
                        <p class="text-danger fw-bolder">Si vous souhaitez modifier votre mot de passe, veuillez remplir les deux champs.</p>
                    ...
                    <div>
                        ...
                        <textarea class="form-control form-control-lg  my-3" name="message" id="message" cols="50" rows="10" 
                        maxlength="500" placeholder="Message"></textarea>
                    </div>
