        ...
        <form class="row " id="productform" enctype="multipart/form-data" method="post" novalidate>
            ...
            <div>
                ...
                <div class="imgtext my-5 row">
                    <textarea class="form-label form-control-lg my-3 " name="description" id="description" cols="50" rows="10" ><?= isset($productobj->description) ? nl2br(html_entity_decode(htmlspecialchars($productobj->description))) : '' ?></textarea>
